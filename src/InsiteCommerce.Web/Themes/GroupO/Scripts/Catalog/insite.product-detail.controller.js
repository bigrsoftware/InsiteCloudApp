...
(function (insite) {
    ...
    (function (catalog) {
        ...
        var ProductDetailController = (function () {
            function ProductDetailController($scope, coreService, cartService, productService, addToWishlistPopupService, productSubscriptionPopupService, settingsService, $stateParams, sessionService, spinnerService, queryString) {
                this.$scope = $scope;
            ...
            ProductDetailController.prototype.getProductData = function (productId) {
                ...
                this.productService.getProduct(null, productId, expand, true, true, "IncludeOnProduct", includeAlternateInventory, this.configuration).then(function (productModel) { _this.getProductCompleted(productModel); }, function (error) { _this.getProductFailed(error); });
            };
            ...
            ProductDetailController.prototype.selectStyledProduct = function (styledProduct) {
                ...
                if (this.product.productUnitOfMeasures && this.product.productUnitOfMeasures.length > 1) {
                    ...
                    if (this.product.productUnitOfMeasures.every(function (elem) { return elem.unitOfMeasure !== _this.product.selectedUnitOfMeasure; })) {
                        this.product.unitOfMeasureDisplay = "";
