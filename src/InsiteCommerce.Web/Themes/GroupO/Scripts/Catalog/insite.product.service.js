...
(function (insite) {
    ...
    (function (catalog) {
        ...
        var ProductService = (function () {
            ...
            ProductService.prototype.getProduct = function (categoryId, productId, expand, addToRecentlyViewed, applyPersonalization, includeAttributes, includeAlternateInventory, configuration) {
                return this.httpWrapperService.executeHttpRequest(this, this.$http({ method: "GET", url: "" + this.productServiceUri + productId, params: this.getProductParams(categoryId, expand, addToRecentlyViewed, applyPersonalization, includeAttributes, includeAlternateInventory, configuration) }), this.getProductCompleted, this.getProductFailed);
            };
            ProductService.prototype.getProductParams = function (categoryId, expand, addToRecentlyViewed, applyPersonalization, includeAttributes, includeAlternateInventory, configuration) {
                var params = {};
                if (expand) {
                    params.expand = expand.join();
                }
