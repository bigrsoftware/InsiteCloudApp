...
(function (insite) {
    ...
    (function (account_1) {
        "use strict";
        var SelectDefaultCustomerController = (function (_super) {
            __extends(SelectDefaultCustomerController, _super);
            function SelectDefaultCustomerController() {
                _super.apply(this, arguments);
                this.showSelectDefaultCustomer = true;
                this.shipFulfillmentMethod = "Ship";
                this.pickupFulfillmentMethod = "PickUp";
            }
            SelectDefaultCustomerController.prototype.init = function () {
                var _this = this;
